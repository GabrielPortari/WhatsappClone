...
public class GrupoSelecionadoAdapter extends RecyclerView.Adapter<GrupoSelecionadoAdapter.MyViewHolder> {
    ...
    public GrupoSelecionadoAdapter(List<Usuario> listaUsuarios, Context c) {
    ...
    public GrupoSelecionadoAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemLista = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recycler_gruposelecionado, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            circleImageView = itemView.findViewById(R.id.imageView_GrupoSelecionado);
            textNome = itemView.findViewById(R.id.textNome_GrupoSelecionado);
